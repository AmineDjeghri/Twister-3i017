...
public class CommentTools {
	...
	public static void addComment(String id_message, String comment, String id_user,String login, MongoCollection<Document> collection) throws JSONException {
	...
	public static void removeComment(String id_message, String id_comment, MongoCollection<Document> collection) throws JSONException {
		...
		Document updateOperationDocument = new Document("id_msg", id_message);
	...
	public static JSONObject listComment(String id_message, MongoCollection<Document> collection) throws JSONException {
		...
		while(cur.hasNext()) {
			...
			oneComment.put("fullName", comment.get("fullName"));
