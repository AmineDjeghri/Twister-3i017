...
public class SessionTools {
	...
	public static String getKey_Session(String id_user, Connection connection) throws SQLException {
		String select = "SELECT key_session FROM session where id_user = ?";
		PreparedStatement preparedStatement=null;
