            ...
            <div className="login">
                <Form className="login__form">
                    ...
                    <Form.Group  controlId="validationCustomUsername">
                        ...
                        <Form.Control placeholder="Nom d'utilisateur" size="sm"
                    ...
                    <Form.Group controlId="formBasicPassword">
                        ...
                        <InputGroup size="sm">
                        <Form.Control type="password" placeholder="mot de passe" size="sm"
                                      ref={(password) => { this.password = password }} onChange={this.handleChange}/>
                        </InputGroup>
                    </Form.Group>
                    <Button className="btn--blue" variant="primary" type="submit"  onClick={this.handleSubmit}>
                        Se connecter
                    </Button>

                    <a href="#" className="text--blue text--small"> Mot de passe oublié ?</a>
                </Form>
